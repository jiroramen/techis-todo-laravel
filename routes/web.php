...
Route::post('/create', [App\Http\Controllers\TaskController::class, 'create'])->name('tasks.create');
Route::post('/delete/{taskId}', [App\Http\Controllers\TaskController::class, 'delete'])->name('tasks.delete');
